...
// party_date is REQUIRED. Must be a parseable date within ±2 years of today
// (catches obviously wrong years like 1995 from a typo, without hard-coding
// a future-only rule that would break tests written for the past).
